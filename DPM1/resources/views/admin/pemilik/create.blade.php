            ...
            <form action="{{ route('pemilik.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="kbli" class="form-control" placeholder="Klasifikasi Baku Lapangan Usaha Indonesia">
                            @error('kbli')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="number" name="sku" class="form-control" placeholder="Surat Keterangan Usaha">
                        @error('sku')
                            <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                        @enderror
                    </div>
