                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <strong><i class="fas fa-book mr-1"></i> Merek Usaha</strong>
                            <p class="text-muted">{{ $umkm->umkm }}</p><hr>

                            <strong><i class="far fa-file-alt mr-1"></i> Skala UMKM</strong>
                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <strong><i class="fas fa-book mr-1"></i> Klasifikasi Baku Lapangan Usaha Indonesia</strong>
                            <p class="text-muted">{{ $umkm->sku }}</p><hr>
                    ...
                    <div class="col-md-11">
                        <div class="form-group">
                            <strong><i class="fas fa-pencil-alt mr-1"></i> Produk Usaha</strong>
                            <p class="text-muted">{{ $umkm->deskripsi }}</p><hr>

                            <strong><i class="fas fa-file mr-1"></i> Keterangan Skala</strong>
