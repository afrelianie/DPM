            ...
            <div class="col-lg-12 offset-lg-12 col-md-12 col-12">
                <div class="card-body bg-secondary">
                    <div class="card-body bg-white">
                        <table id="tabel-data" class="table table-striped table-striped" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th width="30px">No</th>
                                    <th>Nama Usaha</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->nib }}</td>
                                    <td><center>
                                        <a href="{{ url('/umkm/detail', $data->id_umkm) }}" class="btn btn-warning">
                                        Detail</a>
                                    </td></center>
                                </tr>
                                @endforeach
