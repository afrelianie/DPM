    ...
    <div class="col-md-11">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <strong>Foto Produk</strong><hr>
                            <img class="image" width="100%" height="70%" src="{{ asset($umkm->photo)}}" alt="image">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <img class="image" width="100%" height="70%" src="{{ asset($umkm->foto)}}" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <strong><i class="fas fa-cubes"></i> No KBLI</strong>
                            <p class="text-muted">{{ $umkm->kbli }}</p><hr>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <strong><i class="fas fa-home mr-1"></i> Merek Usaha</strong>
                            ...
                            <strong><i class="fas fa-book mr-1"></i> Sektor Usaha</strong>
                            <p class="text-muted">{{ $umkm->sektor }}</p><hr>

                            <strong><i class="fab fa-fw fa-wpforms"></i> Skala Usaha</strong>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <strong><i class="fas fa-users"></i> Tenaga Kerja Indonesia</strong>
        ...
        <div class="col-md-12">
            <div class="modal-footer">
                ...
                <a href="{{ url('admin/umkm/edit', $umkm->id_umkm) }}" class="btn btn-warning">Edit</a>
            </div>
        </div>
        </div>
