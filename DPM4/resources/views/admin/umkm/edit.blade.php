                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="umkm" class="form-control" placeholder="Nama Usaha/Produk/Toko" value="{{ $umkm->umkm }}">
                                @error('umkm')
                                    <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Sektor</label>
                                <input type="text" name="sektor" class="form-control" placeholder="Sektor KBLI" value="{{ $umkm->sektor }}">
                                @error('sektor')
                                    <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>KBLI</label>
                                <input type="number" name="kbli" class="form-control" placeholder="No KBLI" value="{{ $umkm->kbli }}">
                                @error('kbli')
                                    <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun" class="form-control" placeholder="Tahun Beroperasi" value="{{ $umkm->tahun }}">
                                @error('tahun')
                                    <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="Keterangan Usaha" >{{ $umkm->deskripsi }}</textarea>
                            </div>
                            @error('deskripsi')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="alamat" class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="Alamat Usaha" >{{ $umkm->alamat }}</textarea>
                            </div>
                            @error('alamat')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
