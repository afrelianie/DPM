        ...
        <div class="card-body">
            <form action="{{ route('pemilik.update', $pemilik->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp" class="form-control" value="{{ $pemilik->no_hp }}">
                            @error('no_hp')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="" class="control-label">Status Usaha</label>
                            <input type="text" name="status" class="form-control" value="{{ $pemilik->status }}">
                            @error('status')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis" class="form-control" value="{{ $pemilik->jenis }}">
                            @error('jenis')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
