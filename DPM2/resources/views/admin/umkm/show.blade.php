                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <p class="text-muted">{{ $umkm->skala }}</p><hr>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <strong><i class="far fa-file-alt mr-1"></i> Resiko Usaha</strong>
                            <p class="text-muted">{{ $umkm->name }}</p><hr>

                            <strong><i class="far fa-file-alt mr-1"></i> Jumlah Investasi</strong>
                            <p class="text-muted">{{ $umkm->investasi }}</p><hr>
