            ...
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <div class="content-right wow fadeInRight">
                    ...
                    <img src="{{ asset($umkm-> foto)}}" style="width: 100%;">
                        <h3 class="m-0 text-white">{{ $umkm->name }}</h3>
                    <p class="m-0 text-white">{{ $umkm->alamat }}, {{ $umkm->kecamatan }}</p>
                    <!-- End Heading -->
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <strong><i class="far fa-file-alt mr-1"></i>Skala</strong>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <strong><i class="fas fa-file mr-1"></i>NIB</strong>
                                    <p class="text-muted">{{ $umkm->nib }}</p><hr>

                                    <strong><i class="fas fa-map-marker-alt mr-1"></i>Alamat Pemilik</strong>
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <strong><i class="fas fa-pencil-alt mr-1"></i> Keterangan Usaha</strong>
                                    <p class="text-muted">{{ $umkm->deskripsi }}</p><hr>

                                    <strong><i class="fas fa-pencil-alt mr-1"></i> Skala Usaha</strong>
